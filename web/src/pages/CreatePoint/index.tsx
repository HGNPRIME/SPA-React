...
const CreatePoint = () => {
    ...
    function SelectHandleUf(event : ChangeEvent<HTMLSelectElement>){
        const uf = event.target.value
        setSelectedUf(uf)
    }

    function SelectHandleCity(event : ChangeEvent<HTMLSelectElement>){
                    ...
                    <fieldset>
                        ...
                        <div className="field-group">
                            <div className="field">
                                ...
                                <select name="uf" id="uf" value={selectedUf} onChange={SelectHandleUf}>
                            ...
                            <div className="field">
                                ...
                                <select name="city" id="city" value={selectedCity} onChange={SelectHandleCity}>
